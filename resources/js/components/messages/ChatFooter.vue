<template>
    <div class="chat-footer pb-3 pb-lg-7 position-absolute bottom-0 start-0">
        ...
        <!-- Chat: Form -->
        <form class="chat-form rounded-pill bg-dark" data-emoji-form="" method="post" action="/api/messages" @submit.prevent="sendMessage()"> <!--هان ضفنا الراوت الي بعمل تخزيين للبيانات-->
            <input type="hidden" name="_token" :value="$root.csrfToken"> <!--عملنا حقل مخفي هان -->
