...
<html lang="en">
    ...
    <body>
                                ...
                                <div class="container py-8">
                                    ...
                                    <div class="card-list">
                                        @php
                                            $last_letter = '';
                                        @endphp
                                        @foreach ($friends as $friend) {{-- بدنانعرض جميع اليوزرع اساس انهم اصدقاء --}}
                                            @php
                                                $letter = substr($friend->name, 0, 1); //جبنا اول حرف من السترينق
                                            @endphp
                                            @if ($letter != $last_letter)
                                        <div class="my-5">
                                            <small class="text-uppercase text-muted">{{ $letter }}</small> {{-- عرضنا كل الاسماء الي بتبلش بنفس الحرف مع بعض --}}
                                        </div>
                                            @endif
                                            @php
                                                $last_letter = $letter;
        ...
        <script>
            ...
            const csrf_token = "{{ csrf_token() }}"; //عرفنا فاريبل على مستوى ملف البليد
        </script>
        <script src="{{ asset('js/messages.js') }}"></script>
        {{-- <script src="{{ asset('public/build/assets/messages-18b0677f.js') }}"></script> --}}
        {{-- <script src="{{ asset('build/assets/messages-18b0677f.js') }}"></script> --}}
