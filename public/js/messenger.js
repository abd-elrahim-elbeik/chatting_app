...
$('.chat-form').on('submit', function (e) { //بدنا نعمل ليسنر باستخدام الجي كويري
    e.preventDefault();
    let msg = $(this).find('textarea').val(); //بدنا نبحث جوا هاد الفورم على حقل التكست ايريا
    $.post($(this).attr('action'), $(this).serialize() /**بجيب كل البيانات لهاد الفورم وبعملها ك اوبجكت وببعتها بالريكوست */, function (response) { //بعتنا بوست ريكوست باسخدام الاجاكس وافترضنا انو الراوت الي رح ابعت عليه الريكوست موجود بالاكشن تبع الفورم نفسو
...
const getConversations = function() { //انشأنا فانكشن ترجعلناالكونفرزيشن
    $.get('/api/conversations', function(response) { //بعتنا قت ريكوست ع راوت الكونفرزيشن
...
const conversation = function(chat) { //رح تقوم بعرض الشات كارد
