!(function (e) {
    function o(o) {
        for (
            var n, t, s = o[0], m = o[1], c = o[2], u = 0, g = [];
            u < s.length;
            u++
        )
            (t = s[u]),
    ...
    function (e, o, i) {
        ...
        (function (e, n) {
                ...
                p =
                    ((f = []),
                    {
                        ...
                        deactivateTrap: function (e) {
                            var o = f.indexOf(e);
                            -1 !== o && f.splice(o, 1),
                                f.length > 0 && f[f.length - 1].unpause();
                        },
                    });
            function b(e) {
            ...
            function O(e) {
                return (
                    e instanceof E(e).HTMLElement || e instanceof HTMLElement
                );
            }
            function I(e) {
            ...
            function N(e, o) {
                void 0 === o && (o = []);
                var i = (function e(o) {
                        return ["html", "body", "#document"].indexOf(I(o)) >= 0
                    ...
                    a = E(i),
                    r = n
                        ? [a].concat(a.visualViewport || [], P(i) ? i : [])
                        : i,
                    t = o.concat(r);
            ...
            function D(e) {
                return O(e) && "fixed" !== M(e).position
                    ? e.offsetParent
                    : null;
            }
            function q(e) {
                for (var o = E(e), i = D(e); i && B(i); ) i = D(i);
                return i && "body" === I(i) && "static" === M(i).position
                    ? o
                    : i || o;
            }
            w.TinyEmitter = k;
                ...
                if (null != c) {
                    ...
                    switch (t) {
                        case "start":
                            o[c] =
                                Math.floor(o[c]) -
                                Math.floor(i[d] / 2 - n[d] / 2);
                            break;
                        case "end":
                            o[c] =
                                Math.floor(o[c]) +
                                Math.ceil(i[d] / 2 - n[d] / 2);
                    }
                }
                return o;
            }
            ...
            function ie(e) {
                ...
                var j,
                    p = Object.assign({ position: t }, m && oe);
                return s
                    ? Object.assign(
                          {},
                          p,
                    ...
                    t = a.reduce(function (o, i) {
                        var n = de(e, i),
                            a = (function (e) {
                                ...
                                return (
                                    n &&
                                        o.innerHeight - e.clientHeight > 50 &&
                                        (t = o.innerHeight - i.bottom),
                                    {
                                        top: n ? 0 : e.clientTop,
                                        right:
                                            e.clientLeft > i.left
                        ...
                        return (
                            (o.top = Math.max(n.top + a.top, o.top)),
            ...
            function ve(e, o) {
                ...
                var i = o,
                    ...
                    p = e.elements[g ? y : d],
                    b = ue(
                        S(p) ? p : p.contextElement || A(e.elements.popper),
                        t,
                        m
                    ),
                    w = x(h),
                    ...
                    defaultModifiers: [
                        {
                            ...
                            effect: function (e) {
                                var o = e.state,
                                    ...
                                    c = [].concat(
                                        o.scrollParents.reference,
                                        o.scrollParents.popper
                                    );
                                return (
                                    r &&
                        ...
                        },
                        {
                            ...
                            effect: function (e) {
                                ...
                                return (
                                    Object.assign(
                                        o.elements.popper.style,
                                        i.popper
                                    ),
                                    o.elements.arrow &&
                                        Object.assign(
                                            o.elements.arrow.style,
                                            i.arrow
                                        ),
                                    function () {
                                        Object.keys(o.elements).forEach(
                                            function (e) {
                                                var n = o.elements[e],
                                                    a = o.attributes[e] || {},
                                                    r = Object.keys(
                                                        o.styles.hasOwnProperty(
                                                            e
                                                        )
                                                            ? o.styles[e]
                                                            : i[e]
                        ...
                        },
                        {
                            ...
                            fn: function (e) {
                                var o = e.state,
                                    ...
                                    c = s.y;
                                null != o.modifiersData.popperOffsets &&
                                    ((o.modifiersData.popperOffsets.x += m),
                                        ...
                                        var O = "y" === b ? F : H,
                                            ...
                                            ee = Y
                                                ? "y" === b
                                                    ...
                                                    : Y.clientLeft || 0
                                                : 0,
                                            oe = o.modifiersData.offset
                                                ? o.modifiersData.offset[
                                                      o.placement
                                                  ][b]
                                                : 0,
                                            ie = k[b] + X - oe - ee,
                        ...
                        },
                        {
                            ...
                            effect: function (e) {
                                ...
                                null != r &&
                                    ("string" != typeof r ||
                                        (r =
                                            o.elements.popper.querySelector(
                                                r
                                            ))) &&
                                    me(o.elements.popper, r) &&
                                    ((o.elements.arrow = r),
                                    (o.modifiersData[n + "#persistent"] = {
                                        padding: ge(
                                            "number" != typeof s ? s : le(s, W)
                                        ),
                                    }));
                            },
                            requires: ["popperOffsets"],
                        ...
                        },
                        {
                            ...
                            fn: function (e) {
                                var o = e.state,
                                    ...
                                    t = ve(o, { elementContext: "reference" }),
                                    s = ve(o, { altBoundary: !0 }),
                                    m = ye(t, n),
                                    c = ye(s, a, r),
                                    d = he(m),
                                    u = he(c);
                            ...
                            parse: function (o, i) {
                                return (
                                    ...
                                    ("string" == typeof o ? g : u)(o, {
                                        ...
                                        attributes:
                                            "function" == typeof i.attributes
                                                ? i.attributes
                                                : v,
                                        base:
                                            "string" == typeof i.base
                                                ? i.base
                                                : e.base,
                                        ext: i.ext || e.ext,
                                        size:
                    ...
                    function u(e, o) {
                        for (
                            ...
                            for (
                                ...
                                if (
                                    ((v = g.index) !== l &&
                                        s.appendChild(m(u.slice(l, v), !0)),
                                    (h = d((y = g[0]))),
                                    (l = v + y.length),
                                    (j = o.callback(h, o)),
                                    h && j)
                                ) {
                                    for (a in (((f = new Image()).onerror =
                                        o.onerror),
            ...
            class Ie {
                ...
                render() {
                    ...
                    return (
                        (this.emoji = Ee("div", "emoji-picker__preview-emoji")),
                        e.appendChild(this.emoji),
                        (this.name = Ee("div", "emoji-picker__preview-name")),
                        e.appendChild(this.name),
                        this.events.on("showPreview", (e) =>
                            this.showPreview(e)
                        ),
                ...
                showPreview(e) {
                    let o = e.emoji;
                    e.custom
                        ? (o = `<img class="emoji-picker__custom-emoji" src="${e.emoji}">`)
                        : "twemoji" === this.options.style &&
                          (o = ke.parse(e.emoji, Oe)),
            ...
            Fe &&
                "function" == typeof Fe.querySelector &&
                [
            ...
            Ue.___FONT_AWESOME___ || (Ue.___FONT_AWESOME___ = {}),
                Ue.___FONT_AWESOME___.styles ||
                    (Ue.___FONT_AWESOME___.styles = {}),
                Ue.___FONT_AWESOME___.hooks ||
                    (Ue.___FONT_AWESOME___.hooks = {}),
                Ue.___FONT_AWESOME___.shims ||
                    (Ue.___FONT_AWESOME___.shims = []);
            var Ge = Ue.___FONT_AWESOME___,
                Xe = [];
            Ve &&
                ((Fe.documentElement.doScroll
                    ? /^loaded|^c/
                    : /^loaded|^i|^c/
                ).test(Fe.readyState) ||
                ...
                void 0 !== e && void 0 !== e.process && e.process.emit,
                void 0 === n && setTimeout;
                    ...
                    s
                        ...
                        : (function (e) {
                              ...
                              if (eo(t) && i.found && !n.found) {
                                  var s = { x: i.width / i.height / 2, y: 0.5 };
                                  a.style = Qe(
                                      Me({}, r, {
                                          "transform-origin": ""
                                              .concat(s.x + t.x / 16, "em ")
                                              .concat(s.y + t.y / 16, "em"),
                                      })
                                  );
                              }
                              return [
                                  { tag: "svg", attributes: a, children: o },
                              ];
                          })(b)
                );
            }
            var ro =
                (Je.measurePerformance && Re && Re.mark && Re.measure,
                function (e, o, i, n) {
                    var a,
                        r,
                        t,
            ...
            function to(e, o) {
                var i =
                    ...
                    r = Object.keys(o).reduce(function (e, i) {
                        var n = o[i];
                        return (
                            n.icon ? (e[n.iconName] = n.icon) : (e[i] = n), e
                        );
                    }, {});
                "function" != typeof Ge.hooks.addPack || a
                    ? (Ge.styles[e] = Me({}, Ge.styles[e] || {}, r))
                    : Ge.hooks.addPack(e, r),
                    "fas" === e && to("fa", o);
            }
            var so = Ge.styles,
                mo = Ge.shims,
            ...
            function uo(e, o, i) {
                if (e && e[o] && e[o][i])
                    return { prefix: o, iconName: i, icon: e[o][i] };
            }
            function go(e) {
                var o = e.tag,
                    i = e.attributes,
            ...
            function ho(e) {
                ...
                return {
                    ...
                    icon: Array.isArray(n)
                        ...
                        : {
                              tag: "path",
                              attributes: { fill: "currentColor", d: n },
                          },
                };
            }
            function jo() {
            ...
            Me({}, vo, { cx: "256", cy: "364", r: "28" }),
                Me({}, fo, {
                    attributeName: "r",
                    values: "28;14;28;28;14;28;",
                }),
                Me({}, yo, { values: "1;0;1;1;0;1;" }),
                Me({}, vo, {
                    opacity: "1",
                    d: "M263.7,312h-16c-6.6,0-12-5.4-12-12c0-71,77.4-63.9,77.4-107.8c0-20-17.8-40.2-57.4-40.2c-29.1,0-44.3,9.6-59.2,28.7 c-3.9,5-11.1,6-16.2,2.4l-13.1-9.2c-5.6-3.9-6.9-11.8-2.6-17.2c21.2-27.2,46.4-44.7,91.2-44.7c52.3,0,97.4,29.8,97.4,80.2 c0,67.6-77.4,63.5-77.4,107.8C275.7,306.6,270.3,312,263.7,312z",
                }),
                Me({}, yo, { values: "1;0;0;0;0;1;" }),
                Me({}, vo, {
                    opacity: "0",
                    d: "M232.5,134.5l7,168c0.3,6.4,5.6,11.5,12,11.5h9c6.4,0,11.7-5.1,12-11.5l7-168c0.3-6.8-5.2-12.5-12-12.5h-23 C237.7,122,232.2,127.7,232.5,134.5z",
                }),
                Me({}, yo, { values: "0;0;1;1;0;0;" }),
                Ge.styles,
                Ge.styles;
            var wo,
                ko = new ((function () {
            ...
            const Co = Eo({ prefix: "far", iconName: "building" }).html[0],
                So = Eo({ prefix: "fas", iconName: "cat" }).html[0],
                Oo = Eo({ prefix: "fas", iconName: "coffee" }).html[0],
                ...
                Po = Eo({ prefix: "fas", iconName: "icons" }).html[0],
                Lo = Eo({ prefix: "far", iconName: "lightbulb" }).html[0],
                _o = Eo({ prefix: "fas", iconName: "music" }).html[0],
                To = Eo({ prefix: "fas", iconName: "search" }).html[0],
                No = Eo({ prefix: "far", iconName: "smile" }).html[0],
                Bo = Eo({ prefix: "fas", iconName: "times" }).html[0],
            ...
            class Ro {
                ...
                render() {
                    ...
                    return (
                        this.emoji.custom
                            ? (e = this.lazy
                                  ? No
                                  : `<img class="emoji-picker__custom-emoji" src="${this.emoji.emoji}">`)
                            : "twemoji" === this.options.style &&
                              (e = this.lazy ? No : ke.parse(this.emoji.emoji)),
                        ...
                        this.emojiButton.addEventListener("focus", () =>
                            this.onEmojiHover()
                        ),
                        this.emojiButton.addEventListener("blur", () =>
                            this.onEmojiLeave()
                        ),
                        this.emojiButton.addEventListener("click", () =>
                            this.onEmojiClick()
                        ),
                        this.emojiButton.addEventListener("mouseover", () =>
                            this.onEmojiHover()
                        ),
                        this.emojiButton.addEventListener("mouseout", () =>
                            this.onEmojiLeave()
                        ),
                        "twemoji" === this.options.style &&
                            this.lazy &&
                ...
                onEmojiHover() {
                    this.showPreview &&
                        this.events.emit("showPreview", this.emoji);
                }
                onEmojiLeave() {
            ...
            class Vo {
                constructor(e, o, i, n, a = !0) {
                    (this.showVariants = o),
                        ...
                        (this.options = n),
                        (this.lazy = a),
                        (this.emojis = e.filter(
                            (e) =>
                                !e.version ||
                                parseFloat(e.version) <=
                                    parseFloat(n.emojiVersion)
                        ));
                }
                render() {
                    const e = Ee("div", "emoji-picker__container");
                    return (
                        this.emojis.forEach((o) =>
                            e.appendChild(
                                new Ro(
                                    o,
                                    this.showVariants,
                            ...
                            (i = function () {
                                ...
                                return (function l(v) {
                                    var f = {
                                        ...
                                        prepareNextBeginningIndexes: function (
                                            e
                                        ) {
                                            for (
                                                var o = e.length,
                                                    i =
                                                        f.prepareBeginningIndexes(
                                                            e
                                                        ),
                                                    n = [],
                                                    a = i[0],
            ...
            class Ko {
                constructor(e, o, i, n, a) {
                    if (
                        ...
                        (this.emojiData = n.filter(
                            (e) =>
                                e.version &&
                                parseFloat(e.version) <=
                                    parseFloat(i.emojiVersion) &&
                                void 0 !== e.category &&
                                a.indexOf(e.category) >= 0
                        )),
                        this.options.custom)
                    ) {
                ...
                render() {
                    return (
                        (this.searchContainer = Ee(
                            "div",
                            "emoji-picker__search-container"
                        )),
                        (this.searchField = Ee(
                            "input",
                            "emoji-picker__search " + this.options.inputClass
                        )),
                        ...
                        this.options.icons && this.options.icons.search
                            ? this.searchIcon.appendChild(
                                  qo(this.options.icons.search)
                              )
                            : (this.searchIcon.innerHTML = To),
                ...
                setFocusedEmoji(e) {
                    if (this.resultsContainer) {
                        const o = this.resultsContainer.querySelectorAll(
                            "." + Se
                        );
                ...
                handleResultsKeydown(e) {
                    if (this.resultsContainer) {
                        ...
                        "ArrowRight" === e.key
                            ...
                            : "ArrowLeft" === e.key
                            ? this.setFocusedEmoji(
                                  Math.max(0, this.focusedEmojiIndex - 1)
                              )
                            : "ArrowDown" === e.key
                            ? (e.preventDefault(),
                              this.focusedEmojiIndex <
                                  o.length - this.emojisPerRow &&
                                  this.setFocusedEmoji(
                ...
                onKeyUp(e) {
                    if ("Tab" !== e.key && "Shift" !== e.key)
                        if (this.searchField.value) {
                            this.options.icons && this.options.icons.clearSearch
                                ? (Ce(this.searchIcon),
                                  this.searchIcon.appendChild(
                                      qo(this.options.icons.clearSearch)
                                  ))
                                : (this.searchIcon.innerHTML = Bo),
                                (this.searchIcon.style.cursor = "pointer");
                            const e = Ho.go(
                                this.searchField.value,
                                this.emojiData,
                                { allowTypo: !0, limit: 100, key: "name" }
                            ).map((e) => e.obj);
                            this.events.emit("hidePreview"),
                                e.length
                                    ? ((this.resultsContainer = new Vo(
                                          e,
                                          !0,
                                          this.events,
                                          this.options,
            ...
            class Jo {
                ...
                render() {
                    ...
                    e.addEventListener("click", (e) => {
                        ...
                        (this.emoji.variations || []).forEach((e, o) =>
                            this.popup.appendChild(
                                new Ro(
                                    {
                        ...
                        this.popup.addEventListener("keydown", (e) => {
                            "ArrowRight" === e.key
                                ? this.setFocusedEmoji(
                                      Math.min(
                                          this.focusedEmojiIndex + 1,
                                          this.popup.querySelectorAll("." + Se)
                                              .length - 1
                                      )
                                  )
                                : "ArrowLeft" === e.key
                                ? this.setFocusedEmoji(
                                      Math.max(this.focusedEmojiIndex - 1, 0)
                                  )
                                : "Escape" === e.key &&
                                  (e.stopPropagation(),
                                  this.events.emit("hideVariantPopup"));
            ...
            class Xo {
                ...
                render() {
                    ...
                    let o = this.options.showRecents
                        ? [
                              "recents",
                              ...(this.options.categories || xe.categories),
                          ]
                        : this.options.categories || xe.categories;
                    return (
                        this.options.custom && (o = [...o, "custom"]),
                        o.forEach((o) => {
                            const i = Ee(
                                "button",
                            ...
                            this.options.icons.categories[o]
                                ? i.appendChild(
                                      qo(this.options.icons.categories[o])
                                  )
                                : (i.innerHTML = Go[o]),
                                (i.tabIndex = -1),
            ...
            class Yo {
                constructor(e, o, i) {
                    (this.events = e),
                        ...
                        (this.handleKeyDown = (e) => {
                            switch (
                                (this.emojis.removeEventListener(
                                    "scroll",
                                ...
                                case "ArrowRight":
                                    (this.focusedEmoji.tabIndex = -1),
                                        ...
                                        this.currentCategory <
                                            ...
                                            ? (this.options
                                                  .showCategoryButtons &&
                                                  this.categoryButtons.setActiveButton(
                                                      ++this.currentCategory
                                                  ),
                        ...
                        (this.addCategory = (e, o) => {
                            ...
                            (i.innerHTML =
                                this.i18n.categories[e] || Uo.categories[e]),
                        ...
                        (this.highlightCategory = () => {
                            if (
                                ...
                                return;
                            let e = this.headerOffsets.findIndex(
                                (e) => e >= Math.round(this.emojis.scrollTop)
                            );
                            this.emojis.scrollTop + this.emojis.offsetHeight ===
                                this.emojis.scrollHeight && (e = -1),
                                0 === e
                                    ? (e = 1)
                                    : e < 0 && (e = this.headerOffsets.length),
                                this.headerOffsets[e] ===
                                    this.emojis.scrollTop && e++,
                        ...
                        (this.categories = i.categories || xe.categories),
                        i.showRecents &&
                ...
                updateRecents() {
                    if (this.options.showRecents) {
                        $o.recents = Fo();
                        const e = this.emojis.querySelector(
                ...
                render() {
                    return (
                        ...
                        this.options.showCategoryButtons &&
                            ((this.categoryButtons = new Xo(
                                this.options,
                                this.events,
                                this.i18n
                            )),
                            this.container.appendChild(
                                this.categoryButtons.render()
                            )),
                        (this.emojis = Ee("div", "emoji-picker__emojis")),
                        this.options.showRecents && ($o.recents = Fo()),
                        this.options.custom &&
                            ($o.custom = this.options.custom.map((e) => ({
                                ...e,
                                custom: !0,
                            }))),
                        this.categories.forEach((e) =>
                            this.addCategory(e, $o[e])
                        ),
                        requestAnimationFrame(() => {
                            setTimeout(() => {
                                setTimeout(() =>
                ...
                get currentCategoryEl() {
                    return this.emojis.querySelectorAll(
                        ".emoji-picker__container"
                    )[this.currentCategory];
                }
                get focusedEmoji() {
                    return this.currentCategoryEl.querySelectorAll("." + Se)[
                        this.focusedIndex
                    ];
                }
            ...
            class ei {
                ...
                buildPicker() {
                    if (
                        ((this.pickerEl = Ee("div", "emoji-picker")),
                        this.updateTheme(this.theme),
                        this.options.showAnimation ||
                        ...
                        (this.focusTrap = (function (e, o) {
                            ...
                            function d(e) {
                                ...
                                if (
                                    ...
                                    throw new Error(
                                        "`" + e + "` refers to no known node"
                                    );
                                if ("function" == typeof o && !(n = o()))
                                    throw new Error(
                                        "`" + e + "` did not return a node"
                                    );
                                return n;
                            }
                            function u() {
                            ...
                            function g(e) {
                                n.contains(e.target) ||
                                    (a.clickOutsideDeactivates
                                        ? s({
                                              returnFocus: !y.isFocusable(
                                                  e.target
                                              ),
                                          })
                                        : (a.allowOutsideClick &&
                                              a.allowOutsideClick(e)) ||
                                          e.preventDefault());
                            }
                            function l(e) {
                                n.contains(e.target) ||
                    ...
                    if (this.options.showSearch) {
                        const e = new Ko(
                            ...
                            this.options,
                            xe.emoji,
                            (this.options.categories || []).map((e) =>
                                xe.categories.indexOf(e)
                            )
                        ).render();
                        this.pickerEl.appendChild(e);
                    }
                    this.pickerEl.appendChild(this.pickerContent),
                        (this.emojiArea = new Yo(
                            this.events,
                            this.i18n,
                            this.options
                        )),
                        ...
                        this.events.on("showSearchResults", (e) => {
                            Ce(this.pickerContent),
                                e.classList.add("search-results"),
                                this.pickerContent.appendChild(e);
                        }),
                        this.events.on("hideSearchResults", () => {
                            this.pickerContent.firstChild !==
                                this.emojiArea.container &&
                                (Ce(this.pickerContent),
                                this.pickerContent.appendChild(
                                    this.emojiArea.container
                                )),
                        ...
                        this.options.showPreview &&
                            this.pickerEl.appendChild(
                                new Ie(this.events, this.options).render()
                            ),
                        this.events.on(
                            "emoji",
                            ({ emoji: e, showVariants: o }) => {
                                e.variations && o && this.options.showVariants
                        ...
                        (this.wrapper = Ee("div", "emoji-picker__wrapper")),
                    ...
                    (this.hideInProgress = !0),
                        ...
                        setTimeout(
                            () => {
                                ...
                                const e = this.pickerEl.querySelector(
                                    ".emoji-picker__search"
                                );
                                e && (e.value = ""),
                                    this.pickerEl.querySelector(
                ...
                showPicker(e) {
                    if (this.hideInProgress)
                        ...
                        if (
                            ...
                            window.matchMedia("screen and (max-width: 450px)")
                                .matches)
                        ) {
    ...
    function (e, o) {
        ...
        i &&
            i.addEventListener("show.bs.modal", function (e) {
        ...
        [].forEach.call(
            ...
            function (e) {
                function o(o) {
                    ...
                    const i = Math.max(
                        -1,
                        Math.min(1, o.wheelDelta || -o.detail)
                    );
    ...
    function (e, o, i) {
            ...
            : c.forEach((e) => {
                  const o = e.querySelector("[data-emoji-btn]"),
                      i = new t.a({
                          ...
                          initialCategory:
                              null ===
                              localStorage.getItem("emojiPicker.recent")
                                  ? "smileys"
                                  : "recents",
                          i18n: {
                              search: "Search",
        ...
        document.querySelectorAll('[data-theme-toggle="tab"]').forEach((e) => {
            e.addEventListener("click", (o) => {
                o.preventDefault(),
                    new n.a(document.querySelector(e.hash)).show();
            });
        });
        ...
        if (
            document.querySelector(".chat-body-inner") &&
            document.querySelector(".chat-body-inner")
        ) {
            ...
            new ResizeObserver(function () {
                ...
                o &&
                    ...
                    o.setAttribute(
                        "style",
                        `padding-bottom: ${Number(e.offsetHeight)}px`
                    );
            }).observe(e);
        }
        if (document.querySelector("[data-dropzone-area]")) {
            ...
            e.on("addedfile", function (e) {
                ...
                e.on("addedfiles", function (o) {
                    e.previewsContainer.classList.add(
                        "dz-preview-moved",
                        "pb-10",
                        "pt-3",
                        "px-2"
                ...
                e.on("reset", function (o) {
                    e.previewsContainer.classList.remove(
                        "dz-preview-moved",
                        "pb-10",
                        "pt-3",
                        "px-2"
        ...
        window.onload = function () {
            var e;
            (e = ".chat-body-inner"),
                (e = document.querySelectorAll(e)).length &&
                    e[e.length - 1].scrollIntoView(!1, { block: "end" });
        };
        i(12);
    },
]);
